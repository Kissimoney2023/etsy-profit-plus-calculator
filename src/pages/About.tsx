    ...
    <div className="py-24 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24">
          ...
          <h1 className="text-5xl md:text-7xl font-black font-heading text-secondary mb-8 tracking-tighter italic">By Sellers, For Sellers.</h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto font-medium">We built EtsyProfit+ to solve the #1 problem for handmade business owners: understanding the bottom line.</p>
        </div>
        ...
        <div className="space-y-24">
          ...
          <section className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1">
              ...
              <h2 className="text-4xl font-black text-secondary mb-6 tracking-tight">The Mission</h2>
            ...
            <div className="flex-1 p-8 bg-gray-50 rounded-[40px] border-2 border-gray-100 shadow-inner">
          ...
          <section>
            <div className="text-center mb-16">
               <h2 className="text-4xl font-black text-secondary tracking-tight">Core Principles</h2>
            </div>
          ...
          <section className="p-10 bg-secondary rounded-[40px] text-white text-center relative overflow-hidden">
...
const StatItem = ({ icon, label, value }: any) => (
  <div className="flex items-center justify-between p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
    <div className="flex items-center space-x-3">
      <div className="p-2 bg-gray-50 rounded-lg text-primary">{React.cloneElement(icon, { size: 20 })}</div>
...
const ValueCard = ({ icon, title, desc }: any) => (
  <div className="p-10 bg-white rounded-[32px] border-2 border-gray-50 hover:border-primary/20 transition-all text-center group">
    <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform">
