    ...
    <div className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24">
          ...
          <h1 className="text-5xl md:text-7xl font-black font-heading text-secondary mb-8 tracking-tighter italic">Grow With Us.</h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto font-medium">Earn 30% recurring commission for every seller you refer to EtsyProfit+.</p>
        </div>
        ...
        <div className="bg-secondary rounded-[40px] p-10 md:p-20 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl">
              {!submitted ? (
                <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                  <h3 className="text-2xl font-black text-secondary mb-4">Apply to Join</h3>
                  <div>
                    <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Email Address</label>
                    <input type="email" required className="w-full px-4 py-3 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-primary text-secondary font-bold border-none" placeholder="name@email.com" />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Website / Social Handle</label>
                    <input type="text" className="w-full px-4 py-3 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-primary text-secondary font-bold border-none" placeholder="youtube.com/mychannel" />
                  </div>
                ...
                <div className="text-center py-10">
                   ...
                   <p className="text-gray-500 font-medium">We'll be in touch with your partner credentials soon.</p>
                </div>
              )}
            </div>
          </div>
...
const ProgStep = ({ icon, title, desc }: any) => (
  <div className="text-center p-8">
    <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center mx-auto mb-6 text-primary">
